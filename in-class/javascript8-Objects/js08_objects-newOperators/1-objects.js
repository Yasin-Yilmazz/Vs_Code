...
// ornek1: kisiler dizisindeki jobları tek tek yazdirin.
kisiler.forEach((kisi) => console.log(kisi.job));

// ornek2: yasları 1 artırarak yeni bir diziye saklayınız
...
const kucuk33 = kisiler.filter((kisi) => kisi < 33).map((kisi) => kisiler.name);
console.log(kucuk33);
